...
const SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Fiecare cont nou primește gratuit lecția introductivă (o conversație scurtă, de până la 12 replici, care se face o singură dată) și predicțiile de comportament aferente hărții.",
    ],
  },
  {
