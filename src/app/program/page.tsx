...
export const metadata: Metadata = {
  ...
  description:
    ...
    "construite pe terapia schemelor, în orice ordine. O lecție = o ședință.",
  ...
  openGraph: {
    ...
    description:
      "Cinci module, douăsprezece lecții, în orice ordine. Din ce povestești, harta " +
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-6 py-14 sm:py-20">
        ...
        <h1 className="mt-3 font-serif text-4xl leading-tight text-balance sm:text-5xl">
          Douăsprezece lecții. În orice ordine.
        </h1>
        ...
        <dl className="mt-8 grid gap-4 sm:grid-cols-3">
          {[
            ...
            [
              "Orice ordine",
              "Ordinea de mai jos e recomandată, nu impusă. Sari unde te doare.",
            ],
            [
              "Se reia",
                ...
                <ol className="mt-6 grid gap-3 sm:grid-cols-2">
                  {lessons.map((l) => (
                    <li key={l.guide.id}>
                      ...
                      >
                        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-ink-line text-sm text-paper-faint">
                          {l.number}
                        </span>
                        <span className="min-w-0">
                          <span className="flex items-center gap-2">
                            <span
                              ...
                              style={{
                                background: DOMAIN_COLORS[l.guide.domain],
                              }}
                            />
        ...
        <div className="mt-16 rounded-2xl border border-ink-line p-8">
          ...
          <p className="mt-3 max-w-lg leading-relaxed text-paper-dim">
            Îți faci cont, alegi orice lecție și vezi harta formându-se din ce
            spui. Fără card. Apoi, programe de la 149 lei, care nu expiră.
          </p>
