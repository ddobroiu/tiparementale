...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <section className="mx-auto max-w-6xl px-6 pt-14 pb-8 sm:pt-24">
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-paper-dim">
            Vorbește liber. Convingerile care îți conduc reacțiile — despre bani,
            relații, muncă, tine însuți — devin vizibile, se leagă între ele și se
            schimbă în timp, sub ochii tăi.
          </p>
        ...
        <section className="mx-auto max-w-6xl px-6 pb-20">
          <div className="rounded-2xl border border-ink-line p-8 sm:p-14">
            ...
            <p className="mt-5 max-w-xl leading-relaxed text-paper-dim">
              ...
              întărit și ce s-a slăbit față de săptămâna trecută. Fiecare element
              păstrează citatul din care a fost dedus, deci poți verifica oricând
              de unde vine.
            </p>
            <Link
              href="/intra"
        ...
        <section className="mx-auto max-w-6xl px-6 pb-24">
          <div className="flex items-end justify-between gap-4">
            <h2 className="font-serif text-2xl sm:text-3xl">De citit între timp</h2>
            <Link
              href="/articole"
